...
function Home() {
    ...
    const [playAs, setPlayAs] = useState('EITHER');
                ...
                <form className='common-form' action="/games" method="post" onSubmit={handleSubmit}>
                    ...
                    <ul className='args'>
                        <li>
                            ...
                            <input type="radio" name="hostPrefer" id="no-pref" value='EITHER' checked={playAs === 'EITHER'} onChange={_ => setPlayAs('EITHER')}/>
                        </li>
                        <li>
                            <label htmlFor="white">White</label>
                            <input type="radio" name="hostPrefer" id="white" value='WHITE' checked={playAs === 'WHITE'} onChange={_ => setPlayAs('WHITE')}/>
                        </li>
                        <li>
                            <label htmlFor="black">Black</label>
                            <input type="radio" name="hostPrefer" id="black" value='BLACK' checked={playAs === 'BLACK'} onChange={_ => setPlayAs('BLACK')}/>
                        </li>
                    </ul>
